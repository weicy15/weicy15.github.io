...
<div class="hero-intro">
  <div class="hero-intro__main">
    <h1 class="hero-intro__name">韦淳于 <span class="hero-intro__name-en">Chunyu Wei · Wei Chunyu</span></h1>
  ...
  <p class="hero-intro__site-note">
    本站是韦淳于（Chunyu Wei / Wei Chunyu）的独立个人学术主页，域名为 <strong>weichunyu.site</strong>，持续更新研究方向、代表性论文、科研项目与学术动态。
  </p>
  {% endif %}
</div>
...
<div class="project-card">
  <ul class="project-card__list">
    <li><strong>CCF-阿里1688源宝合作基金</strong>，《面向开放式预测任务的数据-模型协同自动构造方法研究》，<strong>主持</strong>，2026年</li>
